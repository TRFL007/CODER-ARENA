      ...
      <div className="grid gap-5 max-w-3xl">
        {contests.map((c) => {
          ...
          return (
            <div
              key={c._id}
              className="bg-[#282828] border border-[#3e3e3e]/40 p-5 rounded-xl"
            >
              ...
              <button
                onClick={() => navigate(isEnded ? `/contest-results/${c._id}` : `/contest/${c._id}`)}
                className={`px-4 py-2 rounded mt-4 text-sm font-medium ${isEnded ? "bg-blue-600 hover:bg-blue-700" : "bg-green-600 hover:bg-green-700"}`}
              >
