  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] px-4 py-8 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-8">
        <div className="rounded-3xl border border-[#3e3e3e]/30 bg-[#282828] p-8 shadow-2xl shadow-black/20">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-3xl bg-[#2a2a2a] border border-[#3e3e3e]/20 p-5">
              <p className="text-sm text-[#8a8a8a]">Challenges available</p>
              <p className="mt-3 text-3xl font-semibold text-white">{loading ? "..." : problemCount}</p>
            </div>
            <div className="rounded-3xl bg-[#2a2a2a] border border-[#3e3e3e]/20 p-5">
              <p className="text-sm text-[#8a8a8a]">Contests live</p>
              <p className="mt-3 text-3xl font-semibold text-white">{loading ? "..." : contestCount}</p>
            </div>
            <div className="rounded-3xl bg-[#2a2a2a] border border-[#3e3e3e]/20 p-5">
              <p className="text-sm text-[#8a8a8a]">Progress</p>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {[
            ...
            { label: "Top 150 Interview", path: "/interview-prep", description: "Master interview questions." },
            { label: "Profile", path: "/setup", description: guest ? "Create your profile." : "Manage your account." },
          ].map((item) => (
            <Link
              key={item.path}
              to={item.path}
              className="rounded-3xl border border-[#3e3e3e]/30 bg-[#282828] p-6 text-white transition hover:-translate-y-1 hover:border-[#00af9b]/50"
            >
