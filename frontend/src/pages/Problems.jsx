...
const Problems = () => {
  ...
  return (
    <div className="p-8 text-white bg-[#1a1a1a] min-h-screen">
      ...
      <div className="space-y-3">
        {filtered.map((problem, index) => (
          <Link key={problem._id} to={`/problems/${problem._id}`}>
            <div className="bg-[#282828] border border-[#3e3e3e]/40 p-4 rounded-lg hover:border-[#00af9b]/50 transition-colors flex items-center gap-4">
