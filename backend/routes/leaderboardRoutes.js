...
Sorted by totalScore (based on difficulty)
=================================
*/
router.get("/global/rankings", async (req, res) => {
  try {
    ...
    const leaderboard = await User.find({})
      ...
      .limit(limit)
      .select("name email totalScore problemsSolved -password");

    res.json(leaderboard);
  } catch (err) {
    console.error("FETCH GLOBAL LEADERBOARD ERROR:", err);
